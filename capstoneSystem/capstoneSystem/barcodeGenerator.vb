Module barcodeGenerator
    ...
    Function Code128(ByVal TheText As String, ByVal CodeLetter As String) As Image
        ...
        Dim Binaryz As String = "" 'A variable contains the text after converting it to a binary
        Dim I As Integer
        Dim NumCode As Integer 'A variable containing the value of the supplementary text calculation
        ...
        Select Case NumCode
            ...
            Case 102
                Binaryz = Binaryz & "00001010001"
        End Select
        Binaryz = Binaryz & "0011100010100" ' End the code by adding the binary to stop all codes

        ' Create an image displaying the number of characters used
        ...
        Dim RectZ As Rectangle = New Rectangle(0, 0, bmp.Width, bmp.Height) ' A rectangle of the image size to give the background white
        ' Brushes to paint the previous rectangle in white
        ...
        ' Paint the previous rectangle in white
